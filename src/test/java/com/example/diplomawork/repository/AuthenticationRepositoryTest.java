...
import static com.example.diplomawork.service.TestData.*;
...
public class AuthenticationRepositoryTest {
    ...
    void setUp() {
        ...
        authenticationRepository.putTokenAndUsername(TOKEN_1, EMAIL_1);
        testTokensAndUsernames.clear();
        testTokensAndUsernames.put(TOKEN_1, EMAIL_1);
    }
    ...
    void putTokenAndUsername() {
        ...
        authenticationRepository.putTokenAndUsername(TOKEN_2, EMAIL_2);
        String afterPut = authenticationRepository.getUsernameByToken(TOKEN_2);
        assertEquals(EMAIL_2, afterPut);
    }
