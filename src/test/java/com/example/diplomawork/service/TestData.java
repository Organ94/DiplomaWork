...
public class TestData {
    ...
    public static final String EMAIL_1 = "Username1";
    public static final String PASSWORD_1 = "Password1";
    public static final User USER_1 = new User(EMAIL_1, PASSWORD_1, null);

    public static final String EMAIL_2 = "Username2";
    public static final String PASSWORD_2 = "Password2";
    public static final User USER_2 = new User(EMAIL_2, PASSWORD_2, null);
    ...
    public static final StorageFile STORAGE_FILE_1 =
            new StorageFile(
                    FILENAME_1,
                    LocalDateTime.now(),
                    SIZE_1,
    ...
    public static final StorageFile STORAGE_FILE_2 =
            new StorageFile(
                    FILENAME_2,
                    LocalDateTime.now(),
                    SIZE_2,
    ...
    public static final StorageFile FOR_RENAME_STORAGE_FILE =
            new StorageFile(
                    FOR_RENAME_FILENAME,
                    LocalDateTime.now(),
                    FOR_RENAME_SIZE,
    ...
    public static final AuthenticationRQ AUTHENTICATION_RQ = new AuthenticationRQ(EMAIL_1, PASSWORD_1);
    public static final AuthenticationRS AUTHENTICATION_RS = new AuthenticationRS(TOKEN_1);

    public static final UsernamePasswordAuthenticationToken USERNAME_PASSWORD_AUTHENTICATION_TOKEN =
